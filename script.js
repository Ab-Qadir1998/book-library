 ...
 // if (inputTitle.value === '' && inputAuthor.value === '' && inputPages.value === '' && !inputIsRead.checked) {
 //     submitBtn.setAttribute('disabled')
 // } else {
 //     submitBtn.removeAttribute('disabled')
 // }

 submitBtn.disabled = inputTitle.value === '' && inputAuthor.value === '' && inputPages.value === '' && !inputIsRead.checked
